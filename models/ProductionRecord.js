...
const createProductionRecordSchema = () => {
  ...
  inspection_plan: { type: Schema.Types.ObjectId, ref: 'InspectionPlan', default: null, index: true },
  inspection_plan_hash: { type: String, trim: true, maxlength: 128, default: '' },
  inspection_runs: [{ type: Schema.Types.ObjectId, ref: 'InspectionRun' }],
  inspection_gate_status: { type: String, enum: ['not_applicable', 'open', 'blocked', 'complete'], default: 'not_applicable', required: true, index: true },
  ...
  oem_formal_action_count: { type: Number, min: 0, default: 0 },
  supplier_formal_action_count: { type: Number, min: 0, default: 0 },
  oem_operational_action_count: { type: Number, min: 0, default: 0 },
  supplier_operational_action_count: { type: Number, min: 0, default: 0 },
  active_production_block_count: { type: Number, min: 0, default: 0 },
  production_control_sequence: { type: Number, min: 0, default: 0 },
  ...
  schema.index({ oem_organization: 1, lifecycle_state: 1, oem_formal_action_count: 1 })
  schema.index({ supplier_organization: 1, lifecycle_state: 1, supplier_formal_action_count: 1 })
